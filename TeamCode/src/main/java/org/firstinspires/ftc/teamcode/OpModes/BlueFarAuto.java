...
import org.firstinspires.ftc.teamcode.common.command.ShootFarBlue;
...
public class BlueFarAuto extends LinearOpMode {
    ...
    private Pose startPose = new Pose(85, 12, Math.toRadians(270)).mirror();
    private Pose shootPose = new Pose(85, 23, Math.toRadians(270)).mirror();
    private Pose parkPose = new Pose(85, 34, Math.toRadians(270)).mirror();
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()){
            if (stage == 0){
                ...
                processor.override(new ShootFarBlue());
